--@STATEMENT
declare
	-- A OS é SPDM Afiliadas, o sistema é Tasy e a unidade é Hospital Geral de Pirajussara.
	-- SPDMA-HGP-TASY
	-- SPDMA:HGP_TASY
    v_usuario varchar2(30):= 'spdma_hgp_tasy';
    v_nome varchar2(100):= 'SPDM Afiliadas - Hospital Geral de Pirajussara';
    v_senha varchar2(30):= 'spdma@hgp2tasy';
    v_dept_cd varchar2(30):= '8';
    v_login_cd varchar2(30):= 'spdma:hgp_tasy';
	v_email varchar(100):= 'jwsouza@apoioprodesp.sp.gov.br';--Email para redefinição de senha
