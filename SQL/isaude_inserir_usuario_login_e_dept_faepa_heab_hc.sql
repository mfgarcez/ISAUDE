...
/*
OSS: FAEPA
Hospital: Hospital Estadual Américo Brasiliense
Assigning_Authority: FAEPA:HEAB_HC
Id Instituição: 14
Usuário: faepa_heab_hc
Senha: faepa!heab14hc
Ambiente: Desenvolvimento
*/
    v_usuario varchar2(30):= 'faepa_heab_hc';
    v_nome varchar2(100):= 'FAEPA - Hospital Estadual Américo Brasiliense';
    v_senha varchar2(30):= 'faepa!heab14hc';
    v_dept_cd varchar2(30):= '14';
    v_login_cd varchar2(30):= 'faepa:heab_hc';
