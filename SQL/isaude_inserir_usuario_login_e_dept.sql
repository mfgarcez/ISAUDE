--@STATEMENT
declare
    v_usuario varchar2(30):= 'emri';
    v_nome varchar2(100):= 'Instituto de Infectologia Emilio Ribas';
    v_senha varchar2(30):= '@Emri3';
    v_dept_cd varchar2(30):= '6';
    v_login_cd varchar2(30):= 'emri_s4sp';
