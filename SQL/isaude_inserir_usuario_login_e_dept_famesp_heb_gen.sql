...
declare
/*
OSS: Fundação para o Desenvolvimento Médico e Hospitalar
Hospital: Hospital Estadual Bauru
Assigning_Authority: famesp:heb_gen
Id Instituição: 13
Usuário: famesp_heb_gen
Senha: famesp!heb13gen
Ambiente: Desenvolvimento
*/
    v_usuario varchar2(30):= 'famesp_heb_gen';
    v_nome varchar2(100):= 'FAMESP - Hospital Estadual Bauru';
    v_senha varchar2(30):= 'famesp!heb13gen';
    v_dept_cd varchar2(30):= '13';
    v_login_cd varchar2(30):= 'famesp:heb_gen';
