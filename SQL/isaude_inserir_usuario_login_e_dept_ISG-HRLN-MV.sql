--@STATEMENT
declare
	-- MV, a OS ISG (Instituto Socrates Guanaes) e a unidade é Hospital Regional do Litoral Norte.
	-- ISG-HRLN-MV
	-- ISG:HRLN_MV
    v_usuario varchar2(30):= 'hrln';
    v_nome varchar2(100):= 'ISG - Hospital Regional do Litoral Norte';
    v_senha varchar2(30):= '@hrLn2';
    v_dept_cd varchar2(30):= '7';
    v_login_cd varchar2(30):= 'isg:hrln_mv';
